...
def select_folder():
    ...
    destination_folder_var.set("")  # Reset destination folder when a folder is selected
...
def compress_images():
    ...
    if single_image:
        # Use the source folder as the destination folder if not specified
        if not destination_folder:
            destination_folder = os.path.join(os.path.dirname(single_image), 'compressed')  # Set destination folder to "compressed" in the same dir
        ...
        # Use the source folder as the destination folder if not specified
        if not destination_folder:
            destination_folder = os.path.join(source_folder, 'compressed')  # Set destination folder to "compressed" in the same dir
